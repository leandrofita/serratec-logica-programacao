...
console.log(`${contNota20} de R$20.00`);
console.log(`${contNota10} de R$10.00`);

if (resto > 0 && resto < 5) {
    console.log(`${contNota5} de R$5.00 (+1 nota de R$5.00 benefício) = ${contNota5+1}.`);
    console.log(`Total de notas: ${contNota20+contNota10+contNota5} (+1 nota de R$5.00 de benefício) = ${contNota20+contNota10+contNota5+1} notas.`);
}
else{
    console.log(`${contNota5} de R$5.00.`);
    console.log(`Total de notas: ${contNota20+contNota10+contNota5} notas.`);
}
